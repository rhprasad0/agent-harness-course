...
| Context Engineering | In progress — first slice passed, Module 09 loop-engineered router | Local Ollama/Llama2 context-rot probe plus a slim Mission Brief Intake Router for context/tool selection | [`labs/context/2026-06-12-context-rot-llama2.md`](./labs/context/2026-06-12-context-rot-llama2.md), [`labs/context/2026-06-13-tool-skill-routing-context-construction.md`](./labs/context/2026-06-13-tool-skill-routing-context-construction.md), [`labs/context/results/2026-06-13T203503Z-mission-brief-router-train-tuned-scoreboard.md`](./labs/context/results/2026-06-13T203503Z-mission-brief-router-train-tuned-scoreboard.md) | Context-rot slice passed. Module 09 scaffold was narrowed to three tools — read evidence, draft brief, or stop for human review. Ryan then used loop engineering: inspect failures, revise the routing policy, rerun the fixed harness, and stop on a predefined target. The train-tuned v3 prompt reached 15/15 on smoke+train and 9/9 on one heldout check. |
