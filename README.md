...
| Context Engineering | Passed — first lab slice | Local Ollama/Llama2 context-rot probe with strict answer-only scoring | [`labs/context/2026-06-12-context-rot-llama2.md`](./labs/context/2026-06-12-context-rot-llama2.md), [`labs/context/results/2026-06-12T140407Z-context-rot-llama2-summary.md`](./labs/context/results/2026-06-12T140407Z-context-rot-llama2-summary.md) | Clean-window run did not support lost-in-the-middle on the fixed fact; boundary run hit Llama2's 4096-token wall and showed why actual `prompt_eval_count` needs to be logged. |
